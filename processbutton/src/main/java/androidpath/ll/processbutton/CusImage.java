...
public class CusImage extends View {
    ...
    public CusImage(Context context, ProcessButton processButton) {
        super(context);
        this.mProcessButton = processButton;
        init();
        // TODO Auto-generated constructor stub
    }

    public CusImage(Context context, AttributeSet attrs, ProcessButton processButton) {
        super(context, attrs);
        this.mProcessButton = processButton;
        init();
        // TODO Auto-generated constructor stub
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //小于1圈
        if (sweepAngle < 360 && mProcessButton.flg_frmwrk_mode == 2) {
            invalidate();
        }else if(mProcessButton.flg_frmwrk_mode == 1){

        }else {//扫完一圈，调用b.finalAnimation()
            sweepAngle = 0;
            startAngle = -90;
            mProcessButton.finalAnimation();
